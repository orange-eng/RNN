...
encoder_inputs = Input(shape=(None, num_encoder_tokens))        #None说明输入是一个不定长度的
...
encoder_model.load_weights(path +"\\out.h5",by_name=True)
...
decoder_model.load_weights(path + "out.h5",by_name=True)
# 建立序号到字母的映射
